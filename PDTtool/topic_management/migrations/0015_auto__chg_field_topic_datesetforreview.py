...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topic.datesetforreview'
        db.alter_column(u'topic_management_topic', 'datesetforreview', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Topic.datesetforreview'
        db.alter_column(u'topic_management_topic', 'datesetforreview', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 29, 0, 0)))
    ...
    models = {
        ...
        u'meeting_management.meeting': {
            ...
            'topics': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'_meetingtopics'", 'symmetrical': 'False', 'to': u"orm['topic_management.Topic']"}),
