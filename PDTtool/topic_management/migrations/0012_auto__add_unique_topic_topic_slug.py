...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Topic', fields ['topic_slug']
        db.create_unique(u'topic_management_topic', ['topic_slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Topic', fields ['topic_slug']
        db.delete_unique(u'topic_management_topic', ['topic_slug'])
    ...
    models = {
        ...
        u'topic_management.topic': {
            ...
            'topic_slug': ('django.db.models.fields.CharField', [], {'default': "'Works'", 'unique': 'True', 'max_length': '8'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
