...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.supervisor_released'
        db.add_column(u'topic_management_topic', 'supervisor_released',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.supervisor_released'
        db.delete_column(u'topic_management_topic', 'supervisor_released')
