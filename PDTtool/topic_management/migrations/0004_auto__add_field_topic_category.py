...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'topic_management_topic', 'category',
                      self.gf('django.db.models.fields.CharField')(default='Intel Press', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.category'
        db.delete_column(u'topic_management_topic', 'category')
    ...
    models = {
        ...
        u'topic_management.topic': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "'Intel Press'", 'max_length': '255'}),
