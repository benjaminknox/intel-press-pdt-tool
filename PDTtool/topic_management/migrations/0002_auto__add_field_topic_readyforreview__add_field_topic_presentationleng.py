...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.readyforreview'
        db.add_column(u'topic_management_topic', 'readyforreview',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Topic.presentationlength'
        db.add_column(u'topic_management_topic', 'presentationlength',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.readyforreview'
        db.delete_column(u'topic_management_topic', 'readyforreview')

        # Deleting field 'Topic.presentationlength'
        db.delete_column(u'topic_management_topic', 'presentationlength')
