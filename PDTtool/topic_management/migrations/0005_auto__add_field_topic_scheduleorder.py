...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.scheduleorder'
        db.add_column(u'topic_management_topic', 'scheduleorder',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.scheduleorder'
        db.delete_column(u'topic_management_topic', 'scheduleorder')
