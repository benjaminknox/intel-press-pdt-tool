...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing index on 'Topic', fields ['topicinmeeting']
        db.delete_index(u'topic_management_topic', ['topicinmeeting_id'])


        # Renaming column for 'Topic.topicinmeeting' to match new field type.
        db.rename_column(u'topic_management_topic', 'topicinmeeting_id', 'topicinmeeting')
        # Changing field 'Topic.topicinmeeting'
        db.alter_column(u'topic_management_topic', 'topicinmeeting', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'topic_management.topic': {
            ...
            'topicinmeeting': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meeting_management.Meeting']", 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
