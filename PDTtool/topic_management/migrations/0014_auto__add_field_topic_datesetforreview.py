...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.datesetforreview'
        db.add_column(u'topic_management_topic', 'datesetforreview',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.date.today),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.datesetforreview'
        db.delete_column(u'topic_management_topic', 'datesetforreview')
    ...
    models = {
        ...
        u'topic_management.topic': {
            ...
            'comments': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['topic_management.Comment']", 'symmetrical': 'False', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'datesetforreview': ('django.db.models.fields.DateTimeField', [], {}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {}),
