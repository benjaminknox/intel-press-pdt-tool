...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.topicorder'
        db.add_column(u'meeting_management_meeting', 'topicorder',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.topicorder'
        db.delete_column(u'meeting_management_meeting', 'topicorder')
    ...
    models = {
        ...
        u'meeting_management.meeting': {
            ...
            'topicorder': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
