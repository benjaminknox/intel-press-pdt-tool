...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.currentlength'
        db.add_column(u'meeting_management_meeting', 'currentlength',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.currentlength'
        db.delete_column(u'meeting_management_meeting', 'currentlength')
