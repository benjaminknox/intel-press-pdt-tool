...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.timeleft'
        db.add_column(u'meeting_management_meeting', 'timeleft',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.timeleft'
        db.delete_column(u'meeting_management_meeting', 'timeleft')
