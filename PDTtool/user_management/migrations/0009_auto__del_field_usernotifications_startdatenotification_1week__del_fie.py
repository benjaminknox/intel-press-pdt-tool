...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'user_management_usernotifications', 'startdatenotification_1week',
                      self.gf('user_management.fields.NotificationField')(default=True, set_name='startdate'),
                      keep_default=False)
        ...
        db.add_column(u'user_management_usernotifications', 'countdownnotification_3days',
                      self.gf('user_management.fields.NotificationField')(default=True, set_name='countdown'),
                      keep_default=False)
