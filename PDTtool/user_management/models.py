...
from pdtresources import dynamic_model
from django.contrib.auth.models import User
from user_management import fields as um_fields
...
fields = {
	'extendeduser':models.OneToOneField(ExtendedUser),
}

#Generate the UserNotifications model
for name,field in settings.NOTIFICATION_FIELDS.iteritems():
	arguments = field['arguments']
	field_dict = {
		field['fieldname']:um_fields.NotificationField(**arguments)
	}
	fields.update(field_dict)

UserNotifications = dynamic_model.create_model('UserNotifications',
	fields=fields,
	module="user_management.models")

UserNotifications.__unicode__ = lambda obj: obj.extendeduser.user.username
