...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategorySchedule'
        db.create_table(u'schedule_management_categoryschedule', (
            ...
            ('schedulecategoryorder', self.gf('django.db.models.fields.IntegerField')()),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('lastmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'schedule_management', ['CategorySchedule'])

        # Adding M2M table for field topics on 'CategorySchedule'
        db.create_table(u'schedule_management_categoryschedule_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('categoryschedule', models.ForeignKey(orm[u'schedule_management.categoryschedule'], null=False)),
            ('topic', models.ForeignKey(orm[u'topic_management.topic'], null=False))
        ))
        db.create_unique(u'schedule_management_categoryschedule_topics', ['categoryschedule_id', 'topic_id'])

        # Adding model 'ScheduleItem'
        db.create_table(u'schedule_management_scheduleitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('publicid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
            ('length', self.gf('django.db.models.fields.IntegerField')(default=15)),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['topic_management.Topic'])),
            ('presenter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('reviewtype', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('lastmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'schedule_management', ['ScheduleItem'])


    def backwards(self, orm):
        # Deleting model 'CategorySchedule'
        db.delete_table(u'schedule_management_categoryschedule')

        # Removing M2M table for field topics on 'CategorySchedule'
        db.delete_table('schedule_management_categoryschedule_topics')

        # Deleting model 'ScheduleItem'
        db.delete_table(u'schedule_management_scheduleitem')
